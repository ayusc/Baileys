...
import { buildMergedTcTokenIndexWrite, isTcTokenExpired, readTcTokenIndex, resolveIssuanceJid, resolveTcTokenJid, storeTcTokenFromMessageNode, storeTcTokensFromIqResult, TC_TOKEN_INDEX_KEY } from '../Utils/tc-token-utils.js';
...
export const extractLinkCodeCompanionRegBuffers = (node) => {
    ...
    const primaryEphemeralPublicKeyWrapped = getBinaryNodeChildBuffer(linkCodeCompanionReg, 'link_code_pairing_wrapped_primary_ephemeral_pub');
    ...
    return {
        ...
        primaryIdentityPublicKey: primaryIdentityPublicKey instanceof Buffer ? primaryIdentityPublicKey : Buffer.from(primaryIdentityPublicKey),
        primaryEphemeralPublicKeyWrapped: primaryEphemeralPublicKeyWrapped instanceof Buffer
